            ...
            <div className="flex flex-col items-center justify-center rounded-xl p-5 lg:w-[500px]">
                ...
                <div className="flex items-start p-5">
                    <form action="" onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <input type="text" name="title" id="title" value={addProducts.title} onChange={handleChange} className='border p-2 border-gray-500 md:w-[420px] md:h-[40px]' required/>
                        <label htmlFor="" className="block text-sm font-medium text-gray-700">points</label>
                        <input type="number" name="points" id="points" value={addProducts.points} onChange={handleChange} className='border p-2 border-gray-500 md:w-[420px] md:h-[40px]' required />
                        <label htmlFor="" className="block text-sm font-medium text-gray-700">brand</label>
                        <input type="text" name="brand" id="brand" value={addProducts.brand} onChange={handleChange} className='border p-2 border-gray-500 md:w-[420px] md:h-[40px]' required />
                        <label htmlFor="" className="block text-sm font-medium text-gray-700">category</label>
                        <input type="text" name="category" id="category" value={addProducts.category} onChange={handleChange} className='border p-2 border-gray-500 md:w-[420px] md:h-[40px]' required />
